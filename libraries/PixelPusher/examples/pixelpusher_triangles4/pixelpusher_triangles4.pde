/*
 *  Some pretty-pretty for larger displays.
 *
 *  Based on a processing.js sketch I saw somewhere, and translated into Java,
 *  and connected to PixelPusher.  I can't find the original site now.  If it
 *  was you, then I'd love to credit you.  let me know. all errors are mine.
 *
